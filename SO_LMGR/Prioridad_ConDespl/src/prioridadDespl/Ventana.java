...
public class Ventana extends javax.swing.JFrame {
    ...
    private int priorEntra, SuspPriorEntra, BloqPriorEntra;
    ...
    private void initComponents() {
        ...
        jTextField_prior = new javax.swing.JTextField();
        ...
        jTextField_prior.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                jTextField_priorActionPerformed(evt);
            }
        });
                    ...
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                            ...
                            .addGroup(layout.createSequentialGroup()
                                ...
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                                .addComponent(jTextField_prior, javax.swing.GroupLayout.PREFERRED_SIZE, 43, javax.swing.GroupLayout.PREFERRED_SIZE)
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                            ...
                            .addComponent(jButton_Agregar)
                            .addComponent(jTextField_prior, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))))
    ...
    private void jButtonQuantumActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonQuantumActionPerformed
        ...
        if(Proc.pS != Proc.pS.sig){ //si hay algun nodo
            ...
            if(Proc.nuevoS.TSUSP != 1){ // si aun debe estar en suspendido
                ...
                Proc.nuevoS=Proc.pS.sig;
                while(Proc.nuevoS != Proc.pS){//se repite hasta encontrar el ultimo nodo
                    TxtArea_Suspendido.append("\n" + Proc.nuevoS.proceso + ".\t[" + Proc.nuevoS.tiempo + "][" + Proc.nuevoS.TSUSP + "]["+Proc.nuevoS.prior+"]");                
            ...
            if(Proc.nuevoS.TSUSP == 1){ // si esta listo para regresar a la cola de LISTO
                SuspPriorEntra = Proc.nuevoS.prior;
                if((critico != null)&&(SuspPriorEntra < critico.prior)){
                    ...
                    Proc.nuevo.prior=Proc.nuevoS.prior;
                    ...
                    while(nuevo!=Proc.p){
                        ...
                        String texto = nuevo.proceso + ".\t [" + nuevo.tiempo + "]["+nuevo.prior+"][";
                    ...
                    Proc.nuevoS.prior=critico.prior;
        ...
        if(Proc.pB != Proc.pB.sig){ //si hay algun nodo
            ...
            if(Proc.nuevoB.TBLOQ != 1){ // si aun debe estar en bloqueado
                ...
                Proc.nuevoB=Proc.pB.sig;
                while(Proc.nuevoB != Proc.pB){//se repite hasta encontrar el ultimo nodo
                    TxtArea_Bloqueado.append("\n" + Proc.nuevoB.proceso + ".\t[" + Proc.nuevoB.tiempo + "][" + Proc.nuevoB.TBLOQ + "]["+ Proc.nuevoB.prior+"]");                
            ...
            if(Proc.nuevoB.TBLOQ == 1){ // si esta listo para regresar a la cola de LISTO
                BloqPriorEntra = Proc.nuevoB.prior;
                if((critico != null)&&(BloqPriorEntra < critico.prior)){
                    ...
                    Proc.nuevo.prior=Proc.nuevoB.prior;
                    Proc.cab.sig=Proc.nuevo;//Actualiza el enlace para apuntar al siguiente nodo 
                    Proc.nuevo.sig=Proc.p; //actualiza el ultimo nodo con la direccion del primero
                    Proc.cab=Proc.nuevo;// actualizar el contenido de la variable para recibir el siguiente nodo
            ...
            if(critico.tiempo == 1){//revisa si el proceso en critico esta listo para salir
                ...
                if(aux==aux.sig){//verifica si hay procesos por atender
                   TxtArea_CRITICO.setText("");
                    ...
                    TxtArea_CRITICO.append(critico.proceso + ".\t[" + critico.tiempo + "]["+critico.prior+"]");
                }
            }
        }
    ...
    private void jButtonBloquearActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonBloquearActionPerformed
        ...
        if(TxtArea_Bloqueado.getText().equals("") && TxtArea_CRITICO.getText().equals("") && TxtArea_Listo1.getText().equals("")){
            ...
            Proc.nuevoB.prior=critico.prior;
    ...
    private void jButton_AgregarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton_AgregarActionPerformed
        ...
        priorEntra = Integer.parseInt(jTextField_prior.getText());
        if((critico != null)&&(priorEntra < critico.prior)){
            ...
            critico.prior = Integer.parseInt(jTextField_prior.getText());
            
            //repinto critico
            TxtArea_CRITICO.setText(critico.proceso + ".\t[" + critico.tiempo + "][" + critico.prior +"]");
        ...
        Proc.nuevo.prior = Integer.parseInt(jTextField_prior.getText());
        Proc.cab.sig=Proc.nuevo;//Actualiza el enlace para apuntar al siguiente nodo 
        Proc.nuevo.sig=Proc.p; //actualiza el ultimo nodo con la direccion del primero
        Proc.cab=Proc.nuevo;// actualizar el contenido de la variable para recibir el siguiente nodo
        ...
        jTextField_prior.setText(borrar);
        nuevo=Proc.p.sig;//asignar direccion del primer nodo que sigue a la cpu
        //int cont=1;
        while(nuevo!=Proc.p){
    ...
    private void jTextField_priorActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jTextField_priorActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_jTextField_priorActionPerformed
    ...
    public javax.swing.JTextField jTextField_prior;
