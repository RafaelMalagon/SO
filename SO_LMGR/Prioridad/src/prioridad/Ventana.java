...
public class Ventana extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jButton1.setText("PAUSAR / REANUDAR");
                            ...
                            .addGroup(layout.createSequentialGroup()
                                ...
                                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    ...
                                    .addGroup(layout.createSequentialGroup()
                                        ...
                                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                                        .addComponent(jTextField_prior, javax.swing.GroupLayout.PREFERRED_SIZE, 32, javax.swing.GroupLayout.PREFERRED_SIZE)
                                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
    ...
    javax.swing.Timer timer = new javax.swing.Timer (1800, new ActionListener(){
        ...
        if(Proc.pB != Proc.pB.sig){ //si hay algun nodo
            ...
            if(Proc.nuevoB.TBLOQ != 1){ // si aun debe estar en bloqueado
                ...
                while(Proc.nuevoB != Proc.pB){//se repite hasta encontrar el ultimo nodo
                    ...
                    modelo.setValueAt(Proc.nuevoB.estado, Integer.parseInt(Proc.nuevoB.proceso),w+1);
        ...
        if(critico != null){ //revisa si hay algo en critico
            if(critico.tiempo == 1){//revisa si el proceso en critico esta listo para salir
                ...
                if(aux==aux.sig){//verifica si hay procesos por atender
                   ...
                   // modelo.setValueAt(critico.estado, Integer.parseInt(critico.proceso),   w+1);
                }
            }
        }
    ...
    private void jButton_AgregarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton_AgregarActionPerformed
        ...
        id= id+1;
        Proc.nuevo =new nodo();//pedir memoria, generar un nodo
        Proc.nuevo.proceso= Integer.toString(id);//asignar numero de proceso
        ...
        String limpiar = "";
        TxtArea_Listo1.setText(limpiar);
        jTextField_tiempo.setText(limpiar);
        jTextField_prior.setText(limpiar);
        nuevo=Proc.p.sig;//asignar direccion del primer nodo que sigue a la cpu
        //int cont=1;
            while(nuevo!=Proc.p){
        ...
        // Agregando filas 
            DefaultTableModel modelo= (DefaultTableModel)tabla.getModel();
            String []fila ={ Proc.nuevo.proceso};
            modelo.addRow(fila);
            fila = null;            
